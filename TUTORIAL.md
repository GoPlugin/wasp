...
## RPS test
- [test](https://github.com/goplugin/wasp/blob/master/examples/simple_rps/main.go#L9)
- [gun](https://github.com/goplugin/wasp/blob/master/examples/simple_rps/gun.go#L23)
```
...
`Gun` must implement this [interface](https://github.com/goplugin/wasp/blob/master/wasp.go#L39)

## VUs test
- [test](https://github.com/goplugin/wasp/blob/master/examples/simple_vu/main.go#L10)
- [vu](https://github.com/goplugin/wasp/blob/master/examples/simple_vu/vu.go#L19)
```
...
`VirtualUser` must implement this [interface](https://github.com/goplugin/wasp/blob/master/wasp.go#L47)

## Profile test (group multiple generators in parallel)
- [test](https://github.com/goplugin/wasp/blob/master/examples/profiles/main_test.go#L11)
- [gun](https://github.com/goplugin/wasp/blob/master/examples/profiles/gun.go#L23)
- [vu](https://github.com/goplugin/wasp/blob/master/examples/profiles/vu.go#L19)
```
...
- [test](https://github.com/goplugin/wasp/blob/master/examples/go_test/main_test.go#L15)
- [gun](https://github.com/goplugin/wasp/blob/master/examples/go_test/gun.go#L23)
```
