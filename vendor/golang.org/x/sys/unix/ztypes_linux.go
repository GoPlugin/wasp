...
const (
	...
	IFLA_BOND_SLAVE_PLI_FAILURE_COUNT         = 0x3
	...
	IFLA_VF_PLI_STATE_AUTO                    = 0x0
	IFLA_VF_PLI_STATE_ENABLE                  = 0x1
	IFLA_VF_PLI_STATE_DISABLE                 = 0x2
	...
	IFLA_STATS_PLI_64                         = 0x1
	IFLA_STATS_PLI_XSTATS                     = 0x2
	IFLA_STATS_PLI_XSTATS_SLAVE               = 0x3
	IFLA_STATS_PLI_OFFLOAD_XSTATS             = 0x4
...
const (
	...
	NCSI_CHANNEL_ATTR_PLI_STATE    = 0x6
...
const (
	...
	BPF_PLI_CREATE                            = 0x1c
	BPF_PLI_UPDATE                            = 0x1d
	BPF_PLI_GET_FD_BY_ID                      = 0x1e
	BPF_PLI_GET_NEXT_ID                       = 0x1f
	...
	BPF_LSM_CGROUP                             = 0x2b
	BPF_PLI_TYPE_UNSPEC                       = 0x0
	BPF_PLI_TYPE_RAW_TRACEPOINT               = 0x1
	BPF_PLI_TYPE_TRACING                      = 0x2
	BPF_PLI_TYPE_CGROUP                       = 0x3
	BPF_PLI_TYPE_ITER                         = 0x4
	BPF_PLI_TYPE_NETNS                        = 0x5
	BPF_PLI_TYPE_XDP                          = 0x6
	BPF_PLI_TYPE_PERF_EVENT                   = 0x7
	BPF_PLI_TYPE_KPROBE_MULTI                 = 0x8
	BPF_PLI_TYPE_STRUCT_OPS                   = 0x9
	BPF_ANY                                    = 0x0
	BPF_NOEXIST                                = 0x1
	BPF_EXIST                                  = 0x2
	BPF_F_LOCK                                 = 0x4
...
const (
	...
	DEVLINK_ESWITCH_INLINE_MODE_PLI                   = 0x1
...
const (
	...
	ETHTOOL_PHY_FAST_PLI_DOWN                                              = 0x2
	ETHTOOL_PHY_EDPD                                                        = 0x3
	ETHTOOL_PLI_EXT_STATE_AUTONEG                                          = 0x0
	ETHTOOL_PLI_EXT_STATE_PLI_TRAINING_FAILURE                            = 0x1
	ETHTOOL_PLI_EXT_STATE_PLI_LOGICAL_MISMATCH                            = 0x2
	ETHTOOL_PLI_EXT_STATE_BAD_SIGNAL_INTEGRITY                             = 0x3
	ETHTOOL_PLI_EXT_STATE_NO_CABLE                                         = 0x4
	ETHTOOL_PLI_EXT_STATE_CABLE_ISSUE                                      = 0x5
	ETHTOOL_PLI_EXT_STATE_EEPROM_ISSUE                                     = 0x6
	ETHTOOL_PLI_EXT_STATE_CALIBRATION_FAILURE                              = 0x7
	ETHTOOL_PLI_EXT_STATE_POWER_BUDGET_EXCEEDED                            = 0x8
	ETHTOOL_PLI_EXT_STATE_OVERHEAT                                         = 0x9
	ETHTOOL_PLI_EXT_SUBSTATE_AN_NO_PARTNER_DETECTED                        = 0x1
	ETHTOOL_PLI_EXT_SUBSTATE_AN_ACK_NOT_RECEIVED                           = 0x2
	ETHTOOL_PLI_EXT_SUBSTATE_AN_NEXT_PAGE_EXCHANGE_FAILED                  = 0x3
	ETHTOOL_PLI_EXT_SUBSTATE_AN_NO_PARTNER_DETECTED_FORCE_MODE             = 0x4
	ETHTOOL_PLI_EXT_SUBSTATE_AN_FEC_MISMATCH_DURING_OVERRIDE               = 0x5
	ETHTOOL_PLI_EXT_SUBSTATE_AN_NO_HCD                                     = 0x6
	ETHTOOL_PLI_EXT_SUBSTATE_LT_KR_FRAME_LOCK_NOT_ACQUIRED                 = 0x1
	ETHTOOL_PLI_EXT_SUBSTATE_LT_KR_PLI_INHIBIT_TIMEOUT                    = 0x2
	ETHTOOL_PLI_EXT_SUBSTATE_LT_KR_PLI_PARTNER_DID_NOT_SET_RECEIVER_READY = 0x3
	ETHTOOL_PLI_EXT_SUBSTATE_LT_REMOTE_FAULT                               = 0x4
	ETHTOOL_PLI_EXT_SUBSTATE_LLM_PCS_DID_NOT_ACQUIRE_BLOCK_LOCK            = 0x1
	ETHTOOL_PLI_EXT_SUBSTATE_LLM_PCS_DID_NOT_ACQUIRE_AM_LOCK               = 0x2
	ETHTOOL_PLI_EXT_SUBSTATE_LLM_PCS_DID_NOT_GET_ALIGN_STATUS              = 0x3
	ETHTOOL_PLI_EXT_SUBSTATE_LLM_FC_FEC_IS_NOT_LOCKED                      = 0x4
	ETHTOOL_PLI_EXT_SUBSTATE_LLM_RS_FEC_IS_NOT_LOCKED                      = 0x5
	ETHTOOL_PLI_EXT_SUBSTATE_BSI_LARGE_NUMBER_OF_PHYSICAL_ERRORS           = 0x1
	ETHTOOL_PLI_EXT_SUBSTATE_BSI_UNSUPPORTED_RATE                          = 0x2
	ETHTOOL_PLI_EXT_SUBSTATE_CI_UNSUPPORTED_CABLE                          = 0x1
	ETHTOOL_PLI_EXT_SUBSTATE_CI_CABLE_TEST_FAILURE                         = 0x2
	...
	ETHTOOL_PLI_MODE_10baseT_Half_BIT                                      = 0x0
	ETHTOOL_PLI_MODE_10baseT_Full_BIT                                      = 0x1
	ETHTOOL_PLI_MODE_100baseT_Half_BIT                                     = 0x2
	ETHTOOL_PLI_MODE_100baseT_Full_BIT                                     = 0x3
	ETHTOOL_PLI_MODE_1000baseT_Half_BIT                                    = 0x4
	ETHTOOL_PLI_MODE_1000baseT_Full_BIT                                    = 0x5
	ETHTOOL_PLI_MODE_Autoneg_BIT                                           = 0x6
	ETHTOOL_PLI_MODE_TP_BIT                                                = 0x7
	ETHTOOL_PLI_MODE_AUI_BIT                                               = 0x8
	ETHTOOL_PLI_MODE_MII_BIT                                               = 0x9
	ETHTOOL_PLI_MODE_FIBRE_BIT                                             = 0xa
	ETHTOOL_PLI_MODE_BNC_BIT                                               = 0xb
	ETHTOOL_PLI_MODE_10000baseT_Full_BIT                                   = 0xc
	ETHTOOL_PLI_MODE_Pause_BIT                                             = 0xd
	ETHTOOL_PLI_MODE_Asym_Pause_BIT                                        = 0xe
	ETHTOOL_PLI_MODE_2500baseX_Full_BIT                                    = 0xf
	ETHTOOL_PLI_MODE_Backplane_BIT                                         = 0x10
	ETHTOOL_PLI_MODE_1000baseKX_Full_BIT                                   = 0x11
	ETHTOOL_PLI_MODE_10000baseKX4_Full_BIT                                 = 0x12
	ETHTOOL_PLI_MODE_10000baseKR_Full_BIT                                  = 0x13
	ETHTOOL_PLI_MODE_10000baseR_FEC_BIT                                    = 0x14
	ETHTOOL_PLI_MODE_20000baseMLD2_Full_BIT                                = 0x15
	ETHTOOL_PLI_MODE_20000baseKR2_Full_BIT                                 = 0x16
	ETHTOOL_PLI_MODE_40000baseKR4_Full_BIT                                 = 0x17
	ETHTOOL_PLI_MODE_40000baseCR4_Full_BIT                                 = 0x18
	ETHTOOL_PLI_MODE_40000baseSR4_Full_BIT                                 = 0x19
	ETHTOOL_PLI_MODE_40000baseLR4_Full_BIT                                 = 0x1a
	ETHTOOL_PLI_MODE_56000baseKR4_Full_BIT                                 = 0x1b
	ETHTOOL_PLI_MODE_56000baseCR4_Full_BIT                                 = 0x1c
	ETHTOOL_PLI_MODE_56000baseSR4_Full_BIT                                 = 0x1d
	ETHTOOL_PLI_MODE_56000baseLR4_Full_BIT                                 = 0x1e
	ETHTOOL_PLI_MODE_25000baseCR_Full_BIT                                  = 0x1f
	ETHTOOL_PLI_MODE_25000baseKR_Full_BIT                                  = 0x20
	ETHTOOL_PLI_MODE_25000baseSR_Full_BIT                                  = 0x21
	ETHTOOL_PLI_MODE_50000baseCR2_Full_BIT                                 = 0x22
	ETHTOOL_PLI_MODE_50000baseKR2_Full_BIT                                 = 0x23
	ETHTOOL_PLI_MODE_100000baseKR4_Full_BIT                                = 0x24
	ETHTOOL_PLI_MODE_100000baseSR4_Full_BIT                                = 0x25
	ETHTOOL_PLI_MODE_100000baseCR4_Full_BIT                                = 0x26
	ETHTOOL_PLI_MODE_100000baseLR4_ER4_Full_BIT                            = 0x27
	ETHTOOL_PLI_MODE_50000baseSR2_Full_BIT                                 = 0x28
	ETHTOOL_PLI_MODE_1000baseX_Full_BIT                                    = 0x29
	ETHTOOL_PLI_MODE_10000baseCR_Full_BIT                                  = 0x2a
	ETHTOOL_PLI_MODE_10000baseSR_Full_BIT                                  = 0x2b
	ETHTOOL_PLI_MODE_10000baseLR_Full_BIT                                  = 0x2c
	ETHTOOL_PLI_MODE_10000baseLRM_Full_BIT                                 = 0x2d
	ETHTOOL_PLI_MODE_10000baseER_Full_BIT                                  = 0x2e
	ETHTOOL_PLI_MODE_2500baseT_Full_BIT                                    = 0x2f
	ETHTOOL_PLI_MODE_5000baseT_Full_BIT                                    = 0x30
	ETHTOOL_PLI_MODE_FEC_NONE_BIT                                          = 0x31
	ETHTOOL_PLI_MODE_FEC_RS_BIT                                            = 0x32
	ETHTOOL_PLI_MODE_FEC_BASER_BIT                                         = 0x33
	ETHTOOL_PLI_MODE_50000baseKR_Full_BIT                                  = 0x34
	ETHTOOL_PLI_MODE_50000baseSR_Full_BIT                                  = 0x35
	ETHTOOL_PLI_MODE_50000baseCR_Full_BIT                                  = 0x36
	ETHTOOL_PLI_MODE_50000baseLR_ER_FR_Full_BIT                            = 0x37
	ETHTOOL_PLI_MODE_50000baseDR_Full_BIT                                  = 0x38
	ETHTOOL_PLI_MODE_100000baseKR2_Full_BIT                                = 0x39
	ETHTOOL_PLI_MODE_100000baseSR2_Full_BIT                                = 0x3a
	ETHTOOL_PLI_MODE_100000baseCR2_Full_BIT                                = 0x3b
	ETHTOOL_PLI_MODE_100000baseLR2_ER2_FR2_Full_BIT                        = 0x3c
	ETHTOOL_PLI_MODE_100000baseDR2_Full_BIT                                = 0x3d
	ETHTOOL_PLI_MODE_200000baseKR4_Full_BIT                                = 0x3e
	ETHTOOL_PLI_MODE_200000baseSR4_Full_BIT                                = 0x3f
	ETHTOOL_PLI_MODE_200000baseLR4_ER4_FR4_Full_BIT                        = 0x40
	ETHTOOL_PLI_MODE_200000baseDR4_Full_BIT                                = 0x41
	ETHTOOL_PLI_MODE_200000baseCR4_Full_BIT                                = 0x42
	ETHTOOL_PLI_MODE_100baseT1_Full_BIT                                    = 0x43
	ETHTOOL_PLI_MODE_1000baseT1_Full_BIT                                   = 0x44
	ETHTOOL_PLI_MODE_400000baseKR8_Full_BIT                                = 0x45
	ETHTOOL_PLI_MODE_400000baseSR8_Full_BIT                                = 0x46
	ETHTOOL_PLI_MODE_400000baseLR8_ER8_FR8_Full_BIT                        = 0x47
	ETHTOOL_PLI_MODE_400000baseDR8_Full_BIT                                = 0x48
	ETHTOOL_PLI_MODE_400000baseCR8_Full_BIT                                = 0x49
	ETHTOOL_PLI_MODE_FEC_LLRS_BIT                                          = 0x4a
	ETHTOOL_PLI_MODE_100000baseKR_Full_BIT                                 = 0x4b
	ETHTOOL_PLI_MODE_100000baseSR_Full_BIT                                 = 0x4c
	ETHTOOL_PLI_MODE_100000baseLR_ER_FR_Full_BIT                           = 0x4d
	ETHTOOL_PLI_MODE_100000baseCR_Full_BIT                                 = 0x4e
	ETHTOOL_PLI_MODE_100000baseDR_Full_BIT                                 = 0x4f
	ETHTOOL_PLI_MODE_200000baseKR2_Full_BIT                                = 0x50
	ETHTOOL_PLI_MODE_200000baseSR2_Full_BIT                                = 0x51
	ETHTOOL_PLI_MODE_200000baseLR2_ER2_FR2_Full_BIT                        = 0x52
	ETHTOOL_PLI_MODE_200000baseDR2_Full_BIT                                = 0x53
	ETHTOOL_PLI_MODE_200000baseCR2_Full_BIT                                = 0x54
	ETHTOOL_PLI_MODE_400000baseKR4_Full_BIT                                = 0x55
	ETHTOOL_PLI_MODE_400000baseSR4_Full_BIT                                = 0x56
	ETHTOOL_PLI_MODE_400000baseLR4_ER4_FR4_Full_BIT                        = 0x57
	ETHTOOL_PLI_MODE_400000baseDR4_Full_BIT                                = 0x58
	ETHTOOL_PLI_MODE_400000baseCR4_Full_BIT                                = 0x59
	ETHTOOL_PLI_MODE_100baseFX_Half_BIT                                    = 0x5a
	ETHTOOL_PLI_MODE_100baseFX_Full_BIT                                    = 0x5b

	ETHTOOL_MSG_USER_NONE                     = 0x0
	ETHTOOL_MSG_STRSET_GET                    = 0x1
	ETHTOOL_MSG_PLIINFO_GET                  = 0x2
	ETHTOOL_MSG_PLIINFO_SET                  = 0x3
	ETHTOOL_MSG_PLIMODES_GET                 = 0x4
	ETHTOOL_MSG_PLIMODES_SET                 = 0x5
	ETHTOOL_MSG_PLISTATE_GET                 = 0x6
	...
	ETHTOOL_MSG_PLIINFO_GET_REPLY            = 0x2
	ETHTOOL_MSG_PLIINFO_NTF                  = 0x3
	ETHTOOL_MSG_PLIMODES_GET_REPLY           = 0x4
	ETHTOOL_MSG_PLIMODES_NTF                 = 0x5
	ETHTOOL_MSG_PLISTATE_GET_REPLY           = 0x6
	...
	ETHTOOL_A_PLIINFO_UNSPEC                 = 0x0
	ETHTOOL_A_PLIINFO_HEADER                 = 0x1
	ETHTOOL_A_PLIINFO_PORT                   = 0x2
	ETHTOOL_A_PLIINFO_PHYADDR                = 0x3
	ETHTOOL_A_PLIINFO_TP_MDIX                = 0x4
	ETHTOOL_A_PLIINFO_TP_MDIX_CTRL           = 0x5
	ETHTOOL_A_PLIINFO_TRANSCEIVER            = 0x6
	ETHTOOL_A_PLIINFO_MAX                    = 0x6
	ETHTOOL_A_PLIMODES_UNSPEC                = 0x0
	ETHTOOL_A_PLIMODES_HEADER                = 0x1
	ETHTOOL_A_PLIMODES_AUTONEG               = 0x2
	ETHTOOL_A_PLIMODES_OURS                  = 0x3
	ETHTOOL_A_PLIMODES_PEER                  = 0x4
	ETHTOOL_A_PLIMODES_SPEED                 = 0x5
	ETHTOOL_A_PLIMODES_DUPLEX                = 0x6
	ETHTOOL_A_PLIMODES_MASTER_SLAVE_CFG      = 0x7
	ETHTOOL_A_PLIMODES_MASTER_SLAVE_STATE    = 0x8
	ETHTOOL_A_PLIMODES_LANES                 = 0x9
	ETHTOOL_A_PLIMODES_RATE_MATCHING         = 0xa
	ETHTOOL_A_PLIMODES_MAX                   = 0xa
	ETHTOOL_A_PLISTATE_UNSPEC                = 0x0
	ETHTOOL_A_PLISTATE_HEADER                = 0x1
	ETHTOOL_A_PLISTATE_PLI                  = 0x2
	ETHTOOL_A_PLISTATE_SQI                   = 0x3
	ETHTOOL_A_PLISTATE_SQI_MAX               = 0x4
	ETHTOOL_A_PLISTATE_EXT_STATE             = 0x5
	ETHTOOL_A_PLISTATE_EXT_SUBSTATE          = 0x6
	ETHTOOL_A_PLISTATE_EXT_DOWN_CNT          = 0x7
	ETHTOOL_A_PLISTATE_MAX                   = 0x7
...
const (
	...
	NFC_CMD_DEP_PLI_UP               = 0x4
	NFC_CMD_DEP_PLI_DOWN             = 0x5
...
const (
	...
	NL80211_ATTR_MLO_PLI_ID                                = 0x139
	NL80211_ATTR_MLO_PLIS                                  = 0x138
	...
	NL80211_CMD_ADD_PLI                                    = 0x94
	NL80211_CMD_ADD_PLI_STA                                = 0x96
	...
	NL80211_CMD_MODIFY_PLI_STA                             = 0x97
	...
	NL80211_CMD_PROBE_MESH_PLI                             = 0x88
	...
	NL80211_CMD_REMOVE_PLI                                 = 0x95
	NL80211_CMD_REMOVE_PLI_STA                             = 0x98
	...
	NL80211_MESHCONF_MAX_PEER_PLIS                         = 0x4
	...
	NL80211_STA_INFO_AIRTIME_PLI_METRIC                    = 0x29
	...
	NL80211_TDLS_DISABLE_PLI                               = 0x4
	NL80211_TDLS_DISCOVERY_REQ                              = 0x0
	NL80211_TDLS_ENABLE_PLI                                = 0x3
