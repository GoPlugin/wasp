...
const (
	...
	FSCTL_LMR_SET_PLI_TRACKING_INFORMATION   = 0x1400EC
	...
	SYMBOLIC_PLI_FLAG_DIRECTORY     = 0x1
)
...
const (
	...
	// Flags for FILE_PLI_INFORMATION
	FILE_PLI_REPLACE_IF_EXISTS                    = 0x00000001
	FILE_PLI_POSIX_SEMANTICS                      = 0x00000002
	FILE_PLI_SUPPRESS_STORAGE_RESERVE_INHERITANCE = 0x00000008
	FILE_PLI_NO_INCREASE_AVAILABLE_SPACE          = 0x00000010
	FILE_PLI_NO_DECREASE_AVAILABLE_SPACE          = 0x00000020
	FILE_PLI_PRESERVE_AVAILABLE_SPACE             = 0x00000030
	FILE_PLI_IGNORE_READONLY_ATTRIBUTE            = 0x00000040
	FILE_PLI_FORCE_RESIZE_TARGET_SR               = 0x00000080
	FILE_PLI_FORCE_RESIZE_SOURCE_SR               = 0x00000100
	FILE_PLI_FORCE_RESIZE_SR                      = 0x00000180
)
